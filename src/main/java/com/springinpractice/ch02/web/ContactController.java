...
/**
 * Spring Web MVC controller exposing a RESTful interface for 
...
public class ContactController {
	...
	/**
	 * Places a list containing all contacts on the passed model, and returns the
	 * logical view name for displaying the contact list.
	 * 
	 * @param model
	 * 			model
	...
	/**
	 * Places the requested contact on the passed model if it exists, and returns the
	 * logical view name for displaying the contact.  Throws a {@link ResourceNotFoundException}
	 * and returns an HTTP 404 (NOT_FOUND) to the client if the request contact
	 * doesn't exist.
	 * 
	 * @param id
	 * 			contact ID
	...
	public String getContact(HttpServletRequest req, @PathVariable("id") long id,
							Model model) {
